...
- **Pages** :
  ...
  - `/onboarding/services` — Étape 3 : services + catégories (**Phase 2 PR5**)
  - `/onboarding/employees` — Étape 4 : employés + services associés (**Phase 2 PR6**)
  - `/onboarding/schedule` — Étape 5 : horaires d'ouverture du salon (**Phase 2 PR7 — EN COURS**)
